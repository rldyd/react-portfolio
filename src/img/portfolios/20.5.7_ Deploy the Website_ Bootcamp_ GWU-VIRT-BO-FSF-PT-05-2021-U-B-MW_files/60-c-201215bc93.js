(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[60],{"2z/i":function(e,o,c){"use strict"
var t=c("HGxv")
var l=c("8WeW")
...
return e},{}),releasedAssignments:e.reduce((e,o)=>{o.scoring_ranges.forEach(c=>{c.assignment_sets.forEach(t=>{t.assignment_set_associations.forEach(t=>{const l=t.assignment_id
e[l]=e[l]||[]
e[l].push({assignment_id:o.trigger_assignment_id,assignment:o.trigger_assignment_model,upper_bound:c.upper_bound,lower_bound:c.lower_bound})})})})
return e},{})}}
let _=s()
...
o["a"]={isEnabled:a,reloadEnv(){_=s()},getItemData(e,o=true){e=e&&e.toString()
return a()?{isCyoeAble:e&&o,isTrigger:e&&o&&i(e),isReleased:d(e),releasedLabel:u(e)}:{}}}},G4i8:function(e,o,c){var t={"./__tests__/lti.resourceImported.test.js":["LFe7",4090],"./__tests__/lti.screenReaderAlert.test.js":["0Guc",4091],"./__tests__/requestFullWindowLaunch.test.js":["o6ta",4092],"./lti.enableScrollEvents.js":["HVU3",4149],"./lti.fetchWindowSize.js":["OANa",4150],"./lti.frameResize.js":["bSyB",4083],"./lti.removeUnloadMessage.js":["tjuu",4093],"./lti.resourceImported.js":["FC2N",4151],"./lti.screenReaderAlert.js":["YYEg",4152],"./lti.scrollToTop.js":["W/R1",4153],"./lti.setUnloadMessage.js":["6fDN",4094],"./lti.showModuleNavigation.js":["NSTA",4154],"./requestFullWindowLaunch.js":["8IHO",4155],"./toggleCourseNavigationMenu.js":["ECMy",3646,4156]}
function l(e){if(!c.o(t,e))return Promise.resolve().then((function(){var o=new Error("Cannot find module '"+e+"'")
o.code="MODULE_NOT_FOUND"
throw o}))
var o=t[e],l=o[0]
return Promise.all(o.slice(1).map(c.e)).then((function(){return c(l)}))}l.keys=function(){return Object.keys(t)}
l.id="G4i8"
e.exports=l},SYfm:function(e,o,c){"use strict"
var t=c("HGxv")
var l=c("8WeW")
...
var i=c("gI0r")
c("Dhso")
var d=function(e,o){for(var c in o)u.call(o,c)&&(e[c]=o[c])
...
o.prototype.setLockState=function(e){return a.a.ajaxJSON("/api/v1/courses/"+this.course_id+"/blueprint_templates/default/restrict_item","PUT",{content_type:this.content_type,content_id:this.content_id,restricted:e},(o=this,function(c){o.model.set("restricted_by_master_course",e)
...
return o}(_.a.View)
var k=function(e,o){for(var c in o)b.call(o,c)&&(e[c]=o[c])
function t(){this.constructor=e}t.prototype=o.prototype
e.prototype=new t
e.__super__=o.prototype
...
return o}(p)},WIG6:function(e,o,c){"use strict"
c.d(o,"a",(function(){return a}))
var t=c("An8g")
c("q1tI")
c("17x9")
var l=c("bJGz")
var r=c("ouhR")
var n=c.n(r)
function a({tool:e,placement:o,acceptedResourceTypes:c,targetResourceType:r,allowItemSelection:a,selectableItems:s,onDismiss:_,open:i}){const d={com_instructure_course_accept_canvas_resource_types:c,com_instructure_course_canvas_resource_type:r,com_instructure_course_allow_canvas_resource_selection:a,com_instructure_course_available_canvas_resources:s,display:"borderless",placement:o}
const u=-1===(null===e||void 0===e?void 0:e.base_url.indexOf("?"))?"?":"&"
const p=`${null===e||void 0===e?void 0:e.base_url}${u}${n.a.param(d)}`
const k=e?e.title:""
return Object(t["a"])(l["a"],{open:i,label:k,onDismiss:_,placement:"end",size:"regular",padding:"0",headerPadding:"medium"},void 0,Object(t["a"])("iframe",{style:{border:"none",display:"block",width:"100%",height:"100%"},"data-testid":"ltiIframe",src:p,title:k,"data-lti-launch":"true"}))}},Z6JD:function(e,o,c){"use strict"
c.d(o,"b",(function(){return k}))
c.d(o,"a",(function(){return m}))
var t=c("HGxv")
var l=c("8WeW")
...
var s=t["default"].scoped("cyoe_assignment_sidebar_score")
var _=c("FdVj")
...
return o}
const p=(e,o)=>{const c=u(o)
return c===a.points.key?f(e,o):c===a.letter_grade.key||c===a.gpa_scale.key?g(e,o):h(e)}
const k=(e,o,c)=>{e||(e=c?"1":"0")
return b(p(e,o),o)}
const b=(e,o)=>{const c=u(o)
return c===a.points.key?s.t("%{score} pts",{score:s.n(e,{precision:2,strip_insignificant_zeros:true})}):c===a.letter_grade.key||c===a.gpa_scale.key?e:s.n(e,{precision:2,percentage:true,strip_insignificant_zeros:true})}
const f=(e,o)=>{if(!i(e))return e
if(0===e)return"0"
const c=_["a"].parse(e)
const t=Number(o.points_possible)||100
return parseFloat((c*t).toFixed(2))}
const g=(e,o)=>{if(""===e)return""
const c=_["a"].parse(e)
const t={letter:null,score:-Infinity}
for(const e in o.grading_scheme){const l=_["a"].parse(o.grading_scheme[e])
if(l<=c&&l>t.score||0===l&&l>c){t.score=l
t.letter=e}}return t.letter?t.letter:c}
const h=e=>{if(!i(e))return e
return Math.floor(100*e)}
const m=(e,o)=>{if("string"===typeof e&&o.grading_type!==a.letter_grade.key&&o.grading_type!==a.gpa_scale.key){const c=_["a"].parse(e.replace(/%$/,""))
if(!isNaN(c))return b(c,o)}return e}},fhP7:function(e,o,c){"use strict"
c.d(o,"k",(function(){return t}))
c.d(o,"e",(function(){return l}))
c.d(o,"f",(function(){return r}))
c.d(o,"g",(function(){return n}))
c.d(o,"h",(function(){return a}))
c.d(o,"l",(function(){return s}))
c.d(o,"i",(function(){return _}))
c.d(o,"b",(function(){return i}))
c.d(o,"j",(function(){return d}))
c.d(o,"c",(function(){return u}))
c.d(o,"d",(function(){return p}))
c.d(o,"a",(function(){return k}))
const t="@"
const l="mentions-marker"
const r="span#"+l
const n="mention-menu"
const a="span#mention-menu"
const s=ENV.DEEP_LINKING_POST_MESSAGE_ORIGIN
const _="mentions.NavigationEvent"
...
const k={ariaControlTemplate:e=>e+"-mention-popup",activeDescendant:(e,o)=>`${e}-mention-popup-item-${o}`}},jFoo:function(e,o,c){"use strict"
c.d(o,"a",(function(){return d}))
c.d(o,"b",(function(){return b}))
var t=c("fhP7")
var l=c("VTBJ")
const r="error"
const n="unsupported_subject"
const a="wrong_origin"
const s="bad_request"
const _=({targetWindow:e,origin:o,subject:c,message_id:t,sendMessages:_=true})=>{const i=(r={})=>{if(!_)return
const n={subject:c+".response"}
t&&(n.message_id=t)
e?e.postMessage(Object(l["a"])(Object(l["a"])({},n),r),o):console.error("Error sending response postMessage: target window does not exist")}
const d=()=>{i({})}
const u=(e,o)=>{const c={code:e}
o&&(c.message=o)
i({error:c})}
const p=e=>{u(r,e)}
const k=e=>{u(s,e)}
const b=()=>{u(a)}
const f=()=>{u(n)}
return{sendResponse:i,sendSuccess:d,sendError:u,sendGenericError:p,sendBadRequestError:k,sendWrongOriginError:b,sendUnsupportedSubjectError:f}}
var i=_
const d={}
const u=["lti.enableScrollEvents","lti.fetchWindowSize","lti.frameResize","lti.removeUnloadMessage","lti.resourceImported","lti.screenReaderAlert","lti.scrollToTop","lti.setUnloadMessage","lti.showModuleNavigation","requestFullWindowLaunch","toggleCourseNavigationMenu"]
const p=["A2ExternalContentReady","LtiDeepLinkingResponse",t["i"],t["b"],t["j"]]
async function k(e){var o,t
if(e.data.source&&e.data.source.includes("react-devtools"))return false
let l
try{l="string"===typeof e.data?JSON.parse(e.data):e.data}catch(e){return false}const r=l.subject||l.messageType
const n=i({targetWindow:e.source,origin:e.origin,subject:r,message_id:l.message_id,sendMessages:null===(o=ENV)||void 0===o||null===(t=o.FEATURES)||void 0===t?void 0:t.lti_platform_storage})
if(p.includes(r))return false
if(!u.includes(r)){n.sendUnsupportedSubjectError()
return false}try{const o=await c("G4i8")(`./${r}.js`)
const t=o.default({message:l,event:e,responseMessages:n})
t||n.sendSuccess()
return true}catch(e){console.error(`Error loading or executing message handler for "${r}"`,e)
n.sendGenericError(e.message)
return false}}function b(){window.addEventListener("message",e=>{""!==e.data&&k(e)})}}}])

//# sourceMappingURL=60-c-201215bc93.js.map