(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[8],{"3O+N":function(e,t,a){e.exports=a("h9kl")},BEYS:function(e,t,a){"use strict"
var n=a("sTlx")
...
l.prototype={constructor:l,logger:h,log:p,registerHelper:function(e,t,a){if(u.call(e)===c){if(a||t)throw new r("Arg not supported with multiple helpers")
...
e.log(n,t)}))}var h={methodMap:{0:"debug",1:"info",2:"warn",3:"error"},DEBUG:0,INFO:1,WARN:2,ERROR:3,level:3,log:function(e,t){if(h.level<=e){var a=h.methodMap[e]
"undefined"!==typeof console&&console[a]&&console[a].call(console,t)}}}
t.logger=h
function p(e,t){h.log(e,t)}t.log=p
var f=function(e){var t={}
n.extend(t,e)
return t}
t.createFrame=f},BGrI:function(e,t,a){"use strict"
var n=a("3H9/")
var r=a("HGxv")
var i=a("8WeW")
...
for(let e=1;e<=12;e++)r.append(l()(`<option value="${e}">${Object(p["a"])(n[e])}</option>`))
return r},day(e,t){const a=l()("<select />",t)
e.includeBlank&&a.append("<option />")
for(let e=1;e<=31;e++)a.append(l()(`<option value="${e}">${e}</option>`))
return a}}
function v(e,t,a=h.a.clone(t)){const n=["type","startYear","endYear","includeBlank","order"]
...
"birthdate"===t.type&&h.a.defaults(t,{startYear:i-1,endYear:i-125,includeBlank:true})
h.a.defaults(t,{startYear:i-5,endYear:i+5,order:o.order||["year","month","day"]})
const d=l()("<span>")
...
d.append(_)
delete a.id}return d}var x=a("scx4")
var D=a("msTH")
var k=a("JOjB")
var w=a("hnvJ")
a("7AEQ")
...
var y=r["default"].scoped("handlebars_helpers")
...
s[n]=this[n]}}return new M.SafeString(Object(p["a"])(r["default"].t.apply(r["default"],T.call(e).concat([s]))))},__i18nliner_escape:function(e){return Object(p["a"])(e)},__i18nliner_safe:function(e){return new p["a"].SafeString(e)},__i18nliner_concat:function(){var e,t
e=2<=arguments.length?T.call(arguments,0,t=arguments.length-1):(t=0,[]),arguments[t++]
return e.join("")},hiddenIf:function(e){if(e)return" display:none; "},hiddenUnless:function(e){if(!e)return" display:none; "},hiddenIfExists:function(e){if(null!=e)return" display:none; "},hiddenUnlessExists:function(e){if(null==e)return" display:none; "},ifExists:function(e,t){return null!=e?t.fn(this):t.inverse(this)},semanticDateRange:function(){return new M.SafeString(f["a"].apply(null,arguments))},contextSensitiveDatetimeTitle:function(e,t){var a,n,r,i,s,o
r=t.hash.justText
i=l.a.datetimeString(e)
o=i
if(ENV&&ENV.CONTEXT_TIMEZONE&&ENV.TIMEZONE!==ENV.CONTEXT_TIMEZONE){s=y.t("#helpers.local","Local")
n=y.t("#helpers.course","Course")
a=l.a.datetimeString(e,{timezone:ENV.CONTEXT_TIMEZONE})
i!==a&&(o=Object(p["a"])(s)+": "+Object(p["a"])(i)+"<br>"+Object(p["a"])(n)+": "+Object(p["a"])(a))}return r?new M.SafeString(o):new M.SafeString('data-tooltip data-html-tooltip-title="'+Object(p["a"])(o)+'"')},friendlyDatetime:function(e,t){var a,r,i,s,o
s=t.hash,i=s.pubdate,a=s.contextSensitive
if(null==e)return
h.a.isDate(e)||(e=n["a"].parse(e))
...
return new M.SafeString("<time data-tooltip data-html-tooltip-title='"+Object(p["a"])(o)+"' datetime='"+e.toISOString()+"' "+l.a.raw(i?"pubdate":void 0)+">\n  <span aria-hidden='true'>"+l.a.friendlyDatetime(r)+"</span>\n  <span class='screenreader-only'>"+o+"</span>\n</time>")},fudge:function(e){return l.a.fudgeDateForProfileTimezone(e)},unfudge:function(e){return l.a.unfudgeDateForProfileTimezone(e)},formattedDate:function(e,t,a){var r
r=a.hash.pubdate
if(null==e)return
h.a.isDate(e)||(e=n["a"].parse(e))
return new M.SafeString("<time data-tooltip title='"+l.a.datetimeString(e)+"' datetime='"+e.toISOString()+"' "+l.a.raw(r?"pubdate":void 0)+">"+Object(p["a"])(e.toString(t))+"</time>")},datetimeFormatted:function(e){return l.a.datetimeString(e)},dateString:function(e){if(!e)return""
...
t=Math.floor(e/60)
a=e%60
return t>0?y.t("Duration: %{hours} hours and %{minutes} minutes",{hours:t,minutes:a}):a>1?y.t("Duration: %{minutes} minutes",{minutes:a}):y.t("Duration: 1 minute")},addIcon:function(e){return new M.SafeString("<i role='presentation' class='icon-"+Object(p["a"])(e)+"'></i>")},dateToString:function(e,t){null==e&&(e="")
...
return"date"===e?y.t("#helpers.accessible_date_only_format","YYYY-MM-DD"):"time"===e?y.t("#helpers.accessible_time_only_format","hh:mm"):y.t("#helpers.accessible_date_format","YYYY-MM-DD hh:mm")},datepickerScreenreaderPrompt:function(e){var t
null==e&&(e="datetime")
t=y.t("#helpers.accessible_date_prompt","Format Like")
e=M.helpers.accessibleDateFormat(e)
return t+" "+e},mimeClass:x["a"],convertApiUserContent:function(e,t){var a,n
n=t.hash
a=D["a"].convert(e,n)
n&&n.forEditing||(a=new M.SafeString(a))
return a},linkify:function(e){var t,a
a=k["a"].formatMessage(e)
t=new M.SafeString(a)
return t},newlinesToBreak:function(e){e||(e="")
return new M.SafeString(Object(p["a"])(e).replace(/\n/g,"<br />"))},not:function(e){return!e},ifEqual:function(){var e,t,a,n,r,i,s,o
...
a=h.a.map(e,(function(e){return t.fn(e)}))
return l.a.toSentence(a)},dateSelect:function(e,t){return new M.SafeString(v(e,t.hash).html())},checkbox:function(e,t){var a,n,r,i,s,o,d,_,u,c,m,f,b,g
r=t.hash
f=e.split(/\./)
m=f.join("_")
if(r.prefix){f.unshift(r.prefix)
delete r.prefix}n=f[0]+h.a.chain(f).rest().map((function(e){return"["+e+"]"})).value().join("")
o=h.a.extend({type:"checkbox",value:1,id:m,name:n},r)
if(null==o.checked){g=h.a.reduce(f,(function(e,t){if(null!=e)return e[t]}),this)
...
return P.call(e,t)>=0?"disabled":""},truncate_left:function(e,t){return M.Utils.escapeExpression(k["a"].truncateText(e.split("").reverse().join(""),{max:t}).split("").reverse().join(""))},truncate:function(e,t){return M.Utils.escapeExpression(k["a"].truncateText(e,{max:t}))},escape_html:function(e){return Object(p["a"])(e)},enrollmentName:d,list:function(e,t){var a,n,r,i,s,o,d
h.a.defaults(t.hash,{separator:", ",propName:null,limit:null,end:"..."})
i=t.hash,r=i.propName,n=i.limit,a=i.end,o=i.separator
s=h.a.map(e,(function(e){return r?e[r]:e}))
n&&(s=s.slice(0,n))
d=s.join(o)
return n&&e.length>n?""+d+a:d},titleize:function(e){var t,a
if(!e)return""
a=e.split(/[ _]+/)
t=h()(a).map((function(e){return e[0].toUpperCase()+e.slice(1)}))
...
return new M.SafeString("<i aria-hidden='true' class='icon-"+Object(p["a"])(a)+"'></i>")},ifGreaterThan:function(e,t,a){return e>t?a.fn(this):a.inverse(this)},n:function(e,t){var a,n,i,s
...
a=t.hash.format
return w["a"][a](e)},lookup:function(e,t){return e&&e[t]}}
for(Y in S){A=S[Y]
...
t["a"]=c={quoteClump:function(e){return"<div class='quoted_text_holder'> <a href='#' class='show_quoted_text_link'>"+Object(d["a"])(o.t("quoted_text_toggle","show quoted text"))+"</a> <div class='quoted_text' style='display: none;'> "+r.a.raw(e.join("\n"))+" </div> </div>"},formatMessage:function(e){var t,a,n,r,i,s,o,l
r=[]
i=[]
e=e.replace(u,(function(e,t){var a
i.push(e===_?_:(a=e,"http://"===a.slice(0,7)||"https://"===a.slice(0,8)||(a="http://"+a),r.push(a),"<a href='"+Object(d["a"])(a)+"'>"+Object(d["a"])(e)+"</a>"))
return _}))
e=Object(d["a"])(e)
...
o=[]
l=e.split("\n")
for(t=0,a=l.length;t<a;t++){n=l[t]
if(n.match(/^(&gt;|>)/))o.push(n)
else{o.length&&s.push(c.quoteClump(o))
o=[]
s.push(n)}}o.length&&s.push(c.quoteClump(o))
return s.join("\n")},delimit:function(e){var t,a,n,r,i
if(isNaN(e))return String(e)
i=e<0?"-":""
t=Math.abs(e)
if(Infinity===t)return String(e)
a=Math.floor(t)
r=t===a?"":String(t).replace(/^\d+\./,".")
while(a>=1e3){n=String(a).replace(/\d+(\d\d\d)$/,",$1")
a=Math.floor(a/1e3)
r=n+r}return i+String(a)+r},truncateText:function(e,t){var a,n,r,i,s,d
null==t&&(t={})
n=null!=(i=t.max)?i:30
a=o.t("ellipsis","...")
d=o.t("word_separator"," ")
e=(null!=e?e:"").replace(/\s+/g,d).trim()
if(!e||e.length<=n)return e
s=0
while(true){r=e.indexOf(d,s+1)
if(r<0||r>n-a.length)break
s=r}s||(s=n-a.length)
return e.substring(0,s)+a},plainText:function(e){return e.replace(/(<([^>]+)>)/gi,"")}}},h9kl:function(e,t,a){"use strict"
var n=a("BEYS")
...
//# sourceMappingURL=8-c-ea44ef3670.js.map